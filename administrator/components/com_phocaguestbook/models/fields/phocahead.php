...
class JFormFieldPhocaHead extends JFormField
{
	...
	protected function getLabel() {
		...
		// Temporary solution
		JHTML::stylesheet( 'administrator/components/com_phocaguestbook/assets/phocaguestbookoptions.css' );
		...
		if ($phocaImage != ''){
			$image 	= JHTML::_('image', 'administrator/components/com_phocaguestbook/assets/images/'. $phocaImage, '' );
		}
