...
<div class="col100">
    <fieldset class="adminform">
        ...
        <?php
			...
			echo $pane->startPanel(JText ::_('BASIC_DATA'), "param-page");
		?>
        ...
        <tr>
            <td width="100" align="right" class="key">
                <label for="gbmailshow">
                    <?php echo JText::_('SHOW_EMAIL'); ?>:
                </label>
            </td>
            <td>
            	<input style="float: none !important" class="text_area" type="radio" name="gbmailshow" id="gbmailshow" value="1" <?php if($this->entry->gbmailshow){echo "checked='checked'";} ?> /><?php echo JText::_('JYES'); ?>
                <input style="float: none !important" class="text_area" type="radio" name="gbmailshow" id="gbmailshow" value="0" <?php if(!$this->entry->gbmailshow){echo "checked='checked'";} ?> /><?php echo JText::_('JNO'); ?>
            </td>
        </tr>
        <tr>
            <td width="100" align="right" class="key">
        ...
        <?php
        echo $pane->endPanel();
        echo $pane->startPanel(JText :: _('CONTACT_DETAILS'), "param-page");
        ?>
        <table class="admintable">
        <tr>
            <td width="100" align="right" class="key">
