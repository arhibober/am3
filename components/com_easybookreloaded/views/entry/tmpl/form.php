...
<div id="easybook">
	...
	<strong><a class="view" href="<?php echo JRoute::_('index.php?option=com_easybookreloaded&view=easybookreloaded'); ?>" style="text-decoration: none !important;"><?php echo JText::_( 'READ_GUESTBOOK'); ?><?php echo JHTML::_('image', 'components/com_easybookreloaded/images/book.png', JText::_('READ_GUESTBOOK').":", 'height="16" border="0" width="16" class="png" style="vertical-align: middle; padding-left: 3px;"'); ?></a></strong>
<br />
<br />
<script type="text/javascript">
    ...
    function DoPrompt(action) 
	{
		...
		{ ?>
      	if (action == "url") 
		{
      		var thisURL = prompt("<?php echo JTEXT::_('ENTER_THE_URL_HERE'); ?>", "http://");
      		var thisTitle = prompt("<?php echo JTEXT::_('ENTER_THE_WEB_PAGE_TITLE'); ?>", "<?php echo JTEXT::_('WEB_PAGE_TITLE'); ?>");
		...
		{ ?>
      	if (action == "email") 
		{
      		var thisEmail = prompt("<?php echo JTEXT::_('ENTER_THE_E-MAIL_ADDRESS'); ?>", "");
      	...
      	if (action == "code") 
		{
			var thisLanguage = prompt("<?php echo JTEXT::_('WHICH_LANGUAGE'); ?>", "");
      	...
      	if (action == "youtube") 
		{
			var thisYoutube = prompt("<?php echo JTEXT::_('YOUTUBE_VIDEO_ID'); ?>", "");
		...
		{ ?>
      	if (action == "image") 
		{
	      	var thisImage = prompt("<?php echo JTEXT::_('ENTER_THE_URL_OF_THE_PICTURE_YOU_WANT_TO_SHOW'); ?>", "http://");
...
<form name='gbookForm' action='<?php JRoute::_('index.php'); ?>' target='_top' method='post'>
	...
	{ ?>
	<tr>
		<td width='130'><?php echo JTEXT::_('IP_ADDRESS'); ?><span class='small'>*</span></td>
	...
	{ ?>
		<tr>
			<td width='130'><label for='gbmail'><?php echo JTEXT::_('EMAIL'); ?></label>
			...
			<?php if ($this->user->guest == 1)
			{ ?>
				<td><input type='text' name='gbmail' id='gbmail' style='width:245px;' class='inputbox' value='' /></td>
			<?php }
			elseif ($this->user->guest == 0 AND !_EASYBOOK_CANEDIT)
			{ ?>
		...
		{ ?>
		<tr>
			<td width='130'><label for='gbmailshow'><?php echo JTEXT::_('SHOW_EMAIL_IN_PUBLIC'); ?></label></td>
	...
	{ ?>
    <tr>
    	<td width='130'><label for='gbicq'><?php echo JTEXT::_('ICQ_NUMBER'); ?></label></td>
	...
	{ ?>
    <tr>
    	<td width='130'><label for='gbaim'><?php echo JTEXT::_('AIM_NICKNAME'); ?></label></td>
	...
	{ ?>
    <tr>
    	<td width='130'><label for='gbmsn'><?php echo JTEXT::_('MSN_MESSENGER'); ?></label></td>
	...
	{ ?>
    <tr>
    	<td width='130'><label for='gbyah'><?php echo JTEXT::_('YAHOO_MESSENGER'); ?></label></td>
	...
	{ ?>
    <tr>
    	<td width='130'><label for='gbskype'><?php echo JTEXT::_('SKYPE_NICKNAME'); ?></label></td>
	...
	{ 
		...
		?>
		<tr>
			<td width='130'><label for='gbvote'><?php echo JTEXT::_('WEBSITE_RATING'); ?></label></td>
			<td>
				<?php
	...
	{ ?>
	<tr>
		<td width='130'><label for='gbtitle'><?php echo JTEXT::_('Title'); ?></label>
	...
	{ ?>
		<tr>
			...
			<?php if ($this->params->get('support_link', false)) 
			{ ?>
				<a href='javascript:x()' onclick='DoPrompt("url");'><img src='<?php echo $this->baseurl ?>/components/com_easybookreloaded/images/world_link.png' hspace='3' border='0' alt='' title='<?php echo JTEXT::_('WEB_ADDRESS'); ?>' height='16' width='16' /></a>
			<?php }
      		if ($this->params->get('support_mail', true)) 
			{ ?>
				<a href='javascript:x()' onclick='DoPrompt("email");'><img src='<?php echo $this->baseurl ?>/components/com_easybookreloaded/images/email_link.png' hspace='3' border='0' alt='' title='<?php echo JTEXT::_('EMAIL_ADDRESS'); ?>' height='16' width='16' /></a>
			<?php }
      		if ($this->params->get('support_pic', false)) 
			{ ?>
				<a href='javascript:x()' onclick='DoPrompt("image_link");'><img src='<?php echo $this->baseurl ?>/components/com_easybookreloaded/images/picture_link.png' hspace='3' border='0' alt='' title='<?php echo JTEXT::_('SHOWS_IMAGE_WITH_A_LINK'); ?>' height='16' width='16' /></a>
			<?php }      		
			if ($this->params->get('support_pic', false)) 
			{ ?>
				<a href='javascript:x()' onclick='DoPrompt("image");'><img src='<?php echo $this->baseurl ?>/components/com_easybookreloaded/images/picture.png' hspace='3' border='0' alt='' title='<?php echo JTEXT::_('SHOWS_IMAGE_FROM_AN_URL'); ?>' height='16' width='16' /></a>
			<?php }
			...
			{ ?>
				<a href='javascript:x()' onclick='DoPrompt("youtube");'><img src='<?php echo $this->baseurl ?>/components/com_easybookreloaded/images/youtube.png' hspace='3' border='0' alt='' title='<?php echo JTEXT::_('Youtube'); ?>' height='16' width='16' /></a>
			<?php } ?>
			<a href='javascript:x()' onclick='insert("[B]", "[/B]")'><img src='<?php echo $this->baseurl ?>/components/com_easybookreloaded/images/text_bold.png' hspace='3' border='0' alt='Bold' title='<?php echo JTEXT::_('Bold'); ?>' height='16' width='16' /></a>
			<a href='javascript:x()' onclick='insert("[I]", "[/I]")'><img src='<?php echo $this->baseurl ?>/components/com_easybookreloaded/images/text_italic.png' hspace='3' border='0' alt='Italic' title='<?php echo JTEXT::_('Italic'); ?>' height='16' width='16' /></a>
			<a href='javascript:x()' onclick='insert("[U]", "[/U]")'><img src='<?php echo $this->baseurl ?>/components/com_easybookreloaded/images/text_underline.png' hspace='3' border='0' alt='Underline' title='<?php echo JTEXT::_('Underline'); ?>' height='16' width='16' /></a>
			<a href='javascript:x()' onclick='insert("[CENTER]", "[/CENTER]")'><img src='<?php echo $this->baseurl ?>/components/com_easybookreloaded/images/text_align_center.png' hspace='3' border='0' alt='Center' title='<?php echo JTEXT::_('Center'); ?>' height='16' width='16' /></a>
			</td>
		</tr>
	<?php } ?>
   	<tr>
		<td width='130' valign='top'><label for='gbtext'><?php echo JTEXT::_('GUESTBOOK_ENTRY'); ?></label><span class='small'>*</span>
		<br /><br />
	...
	{ ?>
		<tr>
			<td width='130'><label for='easycalccheck'><br /><?php echo JText::_('SPAM'); ?></label><span class='small'>*</span></td>
	...
	<p id="easysubmit">
		<span style='padding-left:145px;'><input type='submit' name='send' value='<?php echo JTEXT::_('SUBMIT_ENTRY'); ?>' class='button' /></span>
	</p>
</form>
<p class="easy_small_notice">
	<span>* <?php echo JTEXT::_('REQUIRED_FIELD'); ?></span>
		<?php if ($this->params->get('enable_log_notice', true) == 1 AND $this->params->get('enable_log', true) == 1)
		{
			echo '<br /><span>'.JTEXT::_('IP_LOGGING_NOTICE_FRONTEND').'</span>';
		} ?>
</p>
