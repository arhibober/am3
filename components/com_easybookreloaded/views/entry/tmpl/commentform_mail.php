...
<form name='gbookForm' action='<?php JRoute::_('index.php'); ?>' target='_top' method='post'>
	...
	<?php } ?>
		<tr>
   			<td width='130' valign='top'><?php echo JTEXT::_('ADMIN_COMMENT'); ?>
   			<br />
   			<br />
   			<?php
		...
		<tr><td></td><td><input type="checkbox" name="inform" id="inform" value="1"> <label for='inform'><?php echo JTEXT::_('Inform'); ?></label></td></tr>
		<tr>
			<td width='130'></td>
