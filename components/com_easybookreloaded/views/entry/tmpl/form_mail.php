...
<form name='gbookForm' action='<?php JRoute::_('index.php'); ?>' target='_top' method='post'>
    ...
    <tr>
    	<td width='130'></td>
    	<td style='padding-left: 130px;'><br /><input type='submit' name='send' value='<?php echo JTEXT::_('SUBMIT_ENTRY'); ?>' class='button' /></td>
    </tr>
    </table>
</form>
<p><span class='small' style='padding-left:400px;'>* <?php echo JTEXT::_('REQUIRED_FIELD'); ?></span></p>
